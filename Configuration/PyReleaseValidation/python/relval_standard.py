...
### data ###
workflows[4.5]  = ['', ['RunCosmicsA','RECOCOSD','HARVESTDC']]
...
workflows[4.22] = ['', ['RunCosmics2011A','RECOCOSD','SKIMCOSD','HARVESTDC']]
...
workflows[135.9] = ['ZMM_13',['ZMMFS_13','HARVESTUP15FS']]
...
workflows[25] = ['', ['TTbar','DIGI','RECO','HARVEST']]
workflows[26] = ['', ['WE','DIGI','RECO','HARVEST']]
workflows[29] = ['', ['ZEE','DIGI','RECO','HARVEST']]
...
workflows[7]  = ['', ['Cosmics','DIGICOS','RECOCOS','HARVESTCOS']]
workflows[8]  = ['', ['BeamHalo','DIGICOS','RECOCOS','HARVESTCOS']]
workflows[11] = ['', ['MinBias','DIGI','RECOMIN','HARVEST']]
...
workflows[1325] = ['', ['TTbar_13','DIGIUP15','RECOUP15','HARVESTUP15']]
...
workflows[1307]  = ['', ['Cosmics_UP15','DIGIHAL','RECOHAL','HARVESTHAL']]
workflows[1308]  = ['', ['BeamHalo_13','DIGIHAL','RECOHAL','HARVESTHAL']]
workflows[1311] = ['', ['MinBias_13','DIGIUP15','RECOMINUP15','HARVESTUP15']]
