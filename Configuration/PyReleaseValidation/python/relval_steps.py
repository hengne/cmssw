...
steps['RunHighMulti2015C']={'INPUT':InputInfo(dataSet='/HighMultiplicity/Run2015C-v1/RAW',label='highMulti2015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHighMulti852015C']={'INPUT':InputInfo(dataSet='/HighMultiplicity85/Run2015C-v1/RAW',label='highMulti852015C',events=100000,location='STD', ls=Run2015C)}
