...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_8_0_1-PU25ns_80X_mcRun2_asymptotic_v6_gcc530-v1',      # 5 - fullSim PU 25ns premix for 800pre6
    'CMSSW_8_0_1-PU50ns_80X_mcRun2_startup_v6_gcc530-v1',         # 6 - fullSim PU 50ns premix for 800pre6
    'CMSSW_8_0_1-80X_mcRun2_asymptotic_v6_gcc530_FastSim-v1',         # 7 - fastSim MinBias for mixing for 800pre6
    'CMSSW_8_0_1-PU25ns_80X_mcRun2_asymptotic_v6_gcc530_FastSim-v1', # 8 - fastSim premixed MinBias for 800pre6 
