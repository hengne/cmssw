...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_8_0_0_pre1-PU25ns_76X_mcRun2_asymptotic_v11-v1',         # 5 - fullSim PU 25ns premix
    'CMSSW_8_0_0_pre1-PU50ns_76X_mcRun2_startup_v11-v1',            # 6 - fullSim PU 50ns premix
    'CMSSW_8_0_0_pre1-76X_mcRun2_asymptotic_v11_FastSim-v1',        # 7 - fastSim MinBias for mixing
    'CMSSW_8_0_0_pre1-PU25ns_76X_mcRun2_asymptotic_v11_FastSim-v1', # 8 - fastSim premixed MinBias
