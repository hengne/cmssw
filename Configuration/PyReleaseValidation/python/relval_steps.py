...
steps['RunCharmonium2015C']={'INPUT':InputInfo(dataSet='/Charmonium/Run2015C-v1/RAW',label='charm2015C',events=100000,location='STD', ls=Run2015C)}
steps['RunCommiss2015C']={'INPUT':InputInfo(dataSet='/Commissioning/Run2015C-v1/RAW',label='commis2015C',events=100000,location='STD', ls=Run2015C)}
steps['RunDisplacedJet2015C']={'INPUT':InputInfo(dataSet='/DisplacedJet/Run2015C-v1/RAW',label='displacJet2015C',events=100000,location='STD', ls=Run2015C)}
steps['RunDoubleMuLM2015C']={'INPUT':InputInfo(dataSet='/DoubleMuonLowMass/Run2015C-v1/RAW',label='dblMuLM2015C',events=100000,location='STD', ls=Run2015C)}
...
steps['RunHcalHPDNoise2015C']={'INPUT':InputInfo(dataSet='/HcalHPDNoise/Run2015C-v1/RAW',label='hcalHN2015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHighMulti2015C']={'INPUT':InputInfo(dataSet='/HighMultiplicity/Run2015C-v1/RAW',label='highMult2015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHighMulti852015C']={'INPUT':InputInfo(dataSet='/HighMultiplicity85/Run2015C-v1/RAW',label='highMult852015C',events=100000,location='STD', ls=Run2015C)}
...
steps['RunSingleElectron2015C']={'INPUT':InputInfo(dataSet='/SingleElectron/Run2015C-v1/RAW',label='singleEle2015C',events=100000,location='STD', ls=Run2015C)}
...
steps['RunSinglePhoton2015C']={'INPUT':InputInfo(dataSet='/SinglePhoton/Run2015C-v1/RAW',label='singlePho2015C',events=100000,location='STD', ls=Run2015C)}
...
steps['RunHLTPhys02015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart0/Run2015C-v1/RAW',label='hltPhys02015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys12015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart1/Run2015C-v1/RAW',label='hltPhys12015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys22015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart2/Run2015C-v1/RAW',label='hltPhys22015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys32015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart3/Run2015C-v1/RAW',label='hltPhys32015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys42015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart4/Run2015C-v1/RAW',label='hltPhys42015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys52015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart5/Run2015C-v1/RAW',label='hltPhys52015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys62015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart6/Run2015C-v1/RAW',label='hltPhys62015C',events=100000,location='STD', ls=Run2015C)}
steps['RunHLTPhys72015C']={'INPUT':InputInfo(dataSet='/HLTPhysicspart7/Run2015C-v1/RAW',label='hltPhys72015C',events=100000,location='STD', ls=Run2015C)}
