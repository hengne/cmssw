...
#    'CMSSW_7_1_0_pre5-START71_V1-v2',                      # 3 8 TeV , for the one sample which is part of the routine relval production (RelValZmumuJets_Pt_20_300, because of -v2)
    ...
    'CMSSW_7_4_6-PU25ns_MCRUN2_74_V9-v2',                   # 5 - fullSim premix 25ns
    'CMSSW_7_4_6-PU50ns_MCRUN2_74_V8-v2',                   # 6 - fullSim premix 50ns
    'CMSSW_7_4_6-MCRUN2_74_V9_FastSim-v1'                   # 7 - fastSim minibias for mixing
    ]
