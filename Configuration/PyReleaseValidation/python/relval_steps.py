...
steps['DIGIHI']=merge([{'-s':'DIGI:pdigi_hi,L1,DIGI2RAW,HLT:@frozenHIon,RAW2DIGI,L1Reco'}, hiDefaults, {'--pileup':'HiMixNoPU'}, step2Upg2015Defaults])
...
steps['DIGIHIMIX']=merge([{'-s':'DIGI:pdigi_hi,L1,DIGI2RAW,HLT:@frozenHIon,RAW2DIGI,L1Reco', '-n':2}, hiDefaults, {'--pileup':'HiMix'}, PUHI, step2Upg2015Defaults])
